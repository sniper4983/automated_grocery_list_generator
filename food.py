...
aisles['cheddar cheese'] = 'dairy'
aisles['monterey jack cheese,'] = 'dairy'
aisles['milk'] = 'dairy'
...
aisles['Montreal steak seasoning mix'] = 'seasonings'
...
aisles['pork loin'] = 'meat'
aisles['water chestnuts'] = 'canned'
aisles['cornstarch'] = 'misc'
aisles['pineapple chunks in 100% juice'] = 'canned'
aisles['low sodium soy sauce'] = 'seasonings'
aisles['ground ginger'] = 'seasonings'
aisles['top sirloin'] = 'meat'
aisles['rice wine vinegar'] = 'misc'
aisles['sesame seeds'] = 'seasonings'
aisles['seasame oil'] = 'misc'
aisles['dried lentals'] = 'misc'
aisles['garbanzo'] = 'canned'
aisles['chicken broth'] = 'misc'
aisles['sweet potato'] = 'produce'
aisles['dry enriched parboiled long grain rice'] = 'midc' #substitute with white or brown rice
aisles['unsweetened coconut milk'] = 'canned'
aisles['green curry paste'] = 'misc'
aisles['bamboo shots'] = ''
aisles['boneless pork ribs'] = 'meat'
aisles['tomato paste'] = 'canned'
aisles['maple syrup'] = 'misc'
aisles['quinoa'] = 'misc'
aisles['stew meat'] = 'meat'
aisles['frozen peas'] = 'frozen'
aisles['jalapeno'] = 'produce'
aisles['vegetable broth'] = 'misc'
aisles['pitted dark sweet cherries'] = 'frozen'
aisles['quartered artichoke hearts'] = 'canned'
aisles['french green lentils'] = 'misc'
aisles['orange'] = 'produce' 
aisles['lemon'] = 'produce'
aisles['pork roast'] = 'meat'
aisles['frozen sliced peaches'] = 'frozen'
aisles['fennel seeds'] = 'misc'
aisles['mcintosh apples'] = 'produce'
aisles['cinnamon'] = 'seasonings'
aisles['bosc pears'] = 'produce'
aisles['crushed tomatoes'] = 'canned'
aisles['diced green chilies'] = 'canned' #not mild?
aisles['split peas'] = 'misc'
aisles['roma tomato'] = 'produce'
aisles['gallon freezer bag'] = 'misc'
aisles['quart freezer bag'] = 'misc'
aisles['disposable or aluminum baking pan(9x13”)'] = 'misc'
aisles['aluminum foil'] = 'misc'
aisles['all-purpose flour'] = 'baking'
aisles['italian-seasonings breadcrumbs'] = 'misc'
aisles['baby carrots'] = 'produce'
aisles['bone-in chicken thighs'] = 'meat'
aisles['low moisture part-skim mozzarella cheese'] = 'dairy'
aisles['ricotta cheese'] = 'dairy'
aisles['ground chicken'] = 'meat'
aisles['ketchup'] = 'misc'
aisles['baby back ribs'] = 'meat'
aisles['diced tomatoes with green chilies'] = 'canned'
aisles['beef chuck shoulder roast'] = 'meat'
aisles['onion flakes'] = 'seasonings'
aisles['celery seed'] = 'sesonings'
aisles['bone-in pork shoulder roast'] = 'meat'
aisles['pork shoulder roast'] = 'meat'
aisles['sugar'] = 'baking'
aisles['hot sauce'] = 'misc'
aisles['distilled white vinegar'] = 'misc'
aisles['french baguette'] = 'misc'
aisles['whole milk'] = 'dairy'
aisles['pure vanilla extract'] = 'baking'
aisles['unsweetened cocoa powder'] = 'baking'
aisles['white vinegar'] = 'misc'
aisles['semi sweet chocolate chips'] = 'baking'
aisles['frozen blueberry'] = 'frozen'
aisles['old-fasioned oats'] = 'misc'
aisles['pineaaple'] = 'produce'
aisles['coconut milk'] = 'canned'
aisles['brown rice'] = 'misc'
aisles['old fasioned oats'] = 'misc'
aisles['baking powder'] = 'baking'
aisles['canola oil'] = 'misc'
aisles['applesauce'] = 'misc'
aisles['flax seed'] = 'seasonings'
aisles['baking soda'] = 'baking'
aisles['ground clove'] = ''
aisles['disposable or aluminum loaf pan(9x5”)'] = 'misc'
aisles['sweet bell pepperr'] = 'produce'
aisles['white mushroom'] = 'produce'
aisles['beef broth'] = 'misc'
aisles['tomato juice'] = 'canned'
aisles['ground mustard'] = 'seasonings'
aisles['dry white wine'] = 'misc'
aisles['capers'] = 'seasonings'
aisles['cranberries'] = 'produce'
aisles['balsamic vinegar'] = 'misc'
aisles['apple juice'] = 'misc'
aisles['bourbon'] = 'misc'
aisles['mayonnaise'] = 'misc'
aisles['sugar snap peas'] = 'produce'
aisles['sirloin tip steak'] = 'meat'
aisles['turmeric'] = 'seasonings'
